$(function() {
	...
	$('#sparkel5').sparkline('html', {
		...
		highlightSpotColor: null,
		highlightLineColor: null,
		fillColor: 'rgba(201, 186, 10, 0.09) ',
		chartRangeMin: 0,
		chartRangeMax: 10,
		width: '100%',
		height: 30,
...
function chart(){
		...
		var gradientStrokeempat = ctx.createLinearGradient(60, 21, 1, 12);
		gradientStrokeempat.addColorStop(1, 'rgb(60, 100, 11)');
		gradientStrokeempat.addColorStop(0, 'rgba(43, 111, 3,0.8)');
		var gradientLegendtwo = 'linear-gradient(145deg, rgba(11, 163, 96, 5), rgba(100, 186, 146, 1))';
		...
		var ChartData = {
		  datasets: [{
			data: [10, 20,30,40,30],
		   backgroundColor: [
			 [myVarVal],'#32a8a4','#199113','#5c0808', '#eb690c'
		   ],
			hoverBackgroundColor: [
			 [myVarVal],'#055956','#3cd134', '#f70707' , '#c95a0a'
			],
			borderColor:[
			 [myVarVal],'#32a8a4','#199113', '#5c0808' , '#eb690c'
		   ],
